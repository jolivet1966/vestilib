...
// Utilisée côté client (formulaire hôte) et côté serveur (création checkout)
...
export const TARIFS_VESTILIB: Tarif[] = [
  ...
  { id: '4h-remise',    categorie: '4 heures',   label: 'Remise 4e', description: 'Remise automatique 4e article — 4h', prix: -4, unite: 'article' },
  ...
  { id: '8h-remise',    categorie: '8 heures',   label: 'Remise 4e', description: 'Remise automatique 4e article — 8h', prix: -6, unite: 'article' },
...
// Catégories uniques dans l'ordre
