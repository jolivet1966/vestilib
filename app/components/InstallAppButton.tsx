  ...
  return (
    <>
      <button onClick={handleClick}
        className="flex items-center gap-3 w-full bg-white border-2 border-[#272757] px-5 py-4 rounded-2xl active:scale-95 transition-all">
        ...
        <div className="text-left flex-1">
          <p className="text-[#272757] font-bold text-sm">Installer l'application</p>
