...
export default function InstallBanner() {
  ...
  return (
    <>
      <div className="bg-[#1A3A6B] px-4 py-2.5 flex items-center gap-3">
        ...
        <button onClick={handleInstall}
          className="bg-[#F5C84A] text-[#1A3A6B] text-xs font-bold px-3 py-1.5 rounded-lg flex-shrink-0 active:scale-95 transition-all">
          Installer
        </button>
