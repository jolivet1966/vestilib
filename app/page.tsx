...
function HomeContent() {
  ...
  if (splash) return (
    <div className="min-h-screen bg-[#272757] flex flex-col items-center justify-center relative overflow-hidden" style={{ animation: 'fadeIn 0.4s ease-out' }}>
    ...
    <div className="min-h-screen bg-gray-50 font-sans overflow-x-hidden pb-24 md:pb-6">
      ...
      {connecte && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center px-6">
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full shadow-xl text-center">
            ...
            <h2 className="text-base font-bold text-[#272757] mb-2">Vous êtes connecté !</h2>
      ...
      {compteSuprime && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center px-6">
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full shadow-xl text-center">
            <div className="text-4xl mb-4">✅</div>
            <h2 className="text-base font-bold text-[#272757] mb-2">Compte supprimé</h2>
      ...
      {popup && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center px-6">
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full shadow-xl">
            ...
            <h2 className="text-base font-bold text-[#272757] text-center mb-2">Proposer un point de dépôt</h2>
      ...
      <header className="bg-white px-5 py-3 flex items-center justify-between border-b border-gray-100 sticky top-0 z-10">
        <div className="flex items-center gap-2.5">
          ...
          <p className="text-[#272757] font-black text-base tracking-widest">VESTILIB</p>
        </div>
        {!isConnected ? (
          <Link href="/user/login"
            className="text-xs font-semibold text-[#272757] bg-[#272757]/5 px-4 py-2 rounded-xl">
            Connexion
          </Link>
        ) : (
          <Link href="/profil"
      ...
      <section className="px-4 pt-4 pb-6 md:max-w-5xl md:mx-auto md:px-8 md:pt-10">
        <div className="bg-gradient-to-br from-[#272757] to-[#0C2447] md:bg-none md:bg-white md:border md:border-gray-100 rounded-3xl p-6 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 md:grid md:grid-cols-2 md:gap-10 md:items-center">
            <div>
              <span className="inline-flex items-center gap-1.5 bg-[#F5C84A]/20 md:bg-[#272757]/8 text-[#F5C84A] md:text-[#272757] text-xs font-semibold px-3 py-1 rounded-full mb-4">
      ...
      <section className="px-4 pb-6 space-y-3 md:max-w-5xl md:mx-auto md:px-8 md:pb-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-4">
        <Link href="/map"
          className="flex items-center gap-4 w-full bg-[#272757] px-5 py-4 md:py-6 rounded-2xl shadow-lg shadow-[#272757]/20 active:scale-95 md:hover:scale-[1.02] transition-all">
        ...
        <button onClick={() => setPopup(true)}
          ...
          <div className="w-10 h-10 bg-[#272757]/5 rounded-xl flex items-center justify-center flex-shrink-0">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#272757" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>
            </svg>
          </div>
          <div className="flex-1 text-left">
            <p className="text-[#272757] font-bold text-sm">Proposer un point de dépôt</p>
          ...
          {[
            ...
            <div key={e.step} className={`flex items-start gap-4 px-5 py-4 ${i < arr.length - 1 ? 'border-b border-gray-50' : ''}`}>
              <div className="flex flex-col items-center gap-1 flex-shrink-0 pt-0.5">
                <div className="w-8 h-8 bg-[#272757] rounded-xl flex items-center justify-center">
              ...
              <div className="pb-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="text-sm font-bold text-[#272757]">{e.titre}</p>
                </div>
        ...
        <div className="space-y-2 md:grid md:grid-cols-2 md:gap-3 md:space-y-0">
          {[
            ...
            <div key={i} className="flex items-center gap-4 bg-white border border-gray-100 rounded-2xl px-4 py-3.5 shadow-sm">
              ...
              <div>
                <p className="text-sm font-bold text-[#272757]">{a.titre}</p>
