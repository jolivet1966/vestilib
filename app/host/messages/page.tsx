            ...
            <div className="p-4 border-t border-gray-50">
              ...
              <div className="flex gap-2">
                <textarea value={texte} onChange={e => setTexte(e.target.value)}
                  ...
                  className="flex-1 border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-[#272757] resize-none" />
                <button onClick={envoyerReponse} disabled={sending || !texte}
                  className="bg-[#272757] text-[#F5C84A] font-bold px-4 rounded-xl disabled:opacity-50">
                  ➤
                </button>
              </div>
            </div>
          ...
          <div className="space-y-2">
            {conversations.length === 0 ? (
              ...
              <div key={conv.id} onClick={() => setSelectedConvId(conv.id)}
                className="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm cursor-pointer hover:border-[#272757]/20 transition-colors">
