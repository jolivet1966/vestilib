...
export default function OnboardSuccessPage() {
  return (
    <div style={{minHeight:'100vh',background:'#272757',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'0 32px',textAlign:'center'}}>
      ...
      <Link href="/" style={{background:'#F5C84A',color:'#272757',borderRadius:50,padding:'14px 32px',fontSize:15,fontWeight:600,textDecoration:'none'}}>
        Retour à l'accueil
      </Link>
    </div>
  )
