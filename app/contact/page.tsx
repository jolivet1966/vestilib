      ...
      <div className="max-w-lg md:max-w-xl mx-auto px-4 md:px-8 py-6 md:py-10">
        {sent ? (
          <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm text-center space-y-3">
            ...
            <h2 className="text-lg font-bold text-[#272757]">Message envoyé !</h2>
            ...
            <button onClick={() => router.push('/profil')}
              className="w-full bg-[#272757] text-[#F5C84A] font-bold py-3 rounded-xl hover:bg-[#0C2447] transition-colors text-sm">
              Retour au profil
            </button>
          </div>
        ) : (
          <div className="bg-white rounded-2xl border border-gray-100 p-4 shadow-sm space-y-3">
            ...
            <button onClick={envoyer} disabled={sending}
              className="w-full bg-[#272757] text-[#F5C84A] font-bold py-3 rounded-xl hover:bg-[#0C2447] disabled:opacity-50 transition-colors text-sm">
