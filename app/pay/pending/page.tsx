...
function PendingContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-6 text-center">
      ...
      {bookingCode && (
        <div className="bg-[#272757] rounded-2xl px-6 py-4 mb-4">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-4 max-w-sm w-full mb-6 text-left space-y-2">
        ...
        <div className="flex items-start gap-3">
          <span className="w-6 h-6 rounded-full bg-[#272757] text-[#F5C84A] text-xs flex items-center justify-center flex-shrink-0 mt-0.5">1</span>
          <p className="text-sm text-gray-600">L hote examine votre demande</p>
        </div>
        <div className="flex items-start gap-3">
          <span className="w-6 h-6 rounded-full bg-[#272757] text-[#F5C84A] text-xs flex items-center justify-center flex-shrink-0 mt-0.5">2</span>
          <p className="text-sm text-gray-600">Vous recevez un email d acceptation ou de refus</p>
        </div>
        <div className="flex items-start gap-3">
          <span className="w-6 h-6 rounded-full bg-[#272757] text-[#F5C84A] text-xs flex items-center justify-center flex-shrink-0 mt-0.5">3</span>
          <p className="text-sm text-gray-600">Si accepte, un lien de paiement vous est envoye</p>
        </div>
      </div>
      <Link href="/map" className="bg-[#272757] text-[#F5C84A] font-semibold px-8 py-3 rounded-xl hover:bg-[#0C2447] transition-colors">
        Retour a la carte
      </Link>
    </div>
  )
